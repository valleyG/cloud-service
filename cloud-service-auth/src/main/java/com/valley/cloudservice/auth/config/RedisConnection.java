...
public class RedisConnection  {
    ...
    protected RedisConnection(RedisProperties properties,
    ...
    protected RedisConnection.ConnectionInfo parseUrl(String url) {
        try {
            URI uri = new URI(url);
            ...
            return new RedisConnection.ConnectionInfo(uri, useSsl, password);
        }
